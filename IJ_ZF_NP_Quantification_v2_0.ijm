...
//get infos:
	...
	Dialog.addChoice("select analysis type: ", newArray("macrophage uptake", "endothelial uptake", "circulation"),"endothelial uptake");
	Dialog.addMessage("define channel order:")
	Dialog.addChoice("endothelium: ", newArray("C1-", "C2-", "C3-", "C4-", "C5-", "C6-", "not used"),"C4-");
	Dialog.addChoice("particles: ", newArray("C1-", "C2-", "C3-", "C4-", "C5-", "C6-", "not used"),"C3-");
	Dialog.addChoice("macrophages: ", newArray("C1-", "C2-", "C3-", "C4-", "C5-", "C6-", "not used"),"C1-");
	Dialog.addChoice("Transmission: ", newArray("C1-", "C2-", "C3-", "C4-", "C5-", "C6-", "not used"),"C2-");
...
//variables for channel order:
	endo=Dialog.getChoice();																		//variable for endothelium channel
	par=Dialog.getChoice();																			//variable for particle channel
	mac=Dialog.getChoice();																			//variable for macrophage channel
	tra=Dialog.getChoice();																			//variable for transmission channel
	mar5=Dialog.getChoice();																		//variable for additional marker
...
//values for particle detection:
	...
	ERDir = dir2 + "ERRORS" + File.separator;
	print(ERDir);
	File.makeDirectory(ERDir);
	if (!File.exists(ERDir))
...
//NEW
				...
				run("Flatten");
				print("ERROR_M01: saving failed image in"+ERDir+"");
				saveAs("Gif", ERDir+title2+"_par_failed.gif");
				print("________________");
				print("SKIPPING IMAGE "+title1+"");
				print("________________");
//manual option?		//waitForUser("ERROR_M01: Unable to detect particle signal in "+title1+"");
				print("ERROR_M01: Unable to detect particle signal in "+title1+"");
			}
			if(ERROR==false){		
				if((step==true)|(stepP==true)){
					setBatchMode("show");
...
//NEW
					...
					run("Enhance Contrast", "saturated=0.35");
					run("Flatten");
					print("ERROR_M02: saving failed image in"+ERDir+"");
					saveAs("Gif", ERDir+title2+"_mp_failed.gif");
					print("________________");
					print("SKIPPING IMAGE "+title1+"");
					print("________________");
//manual option?			//waitForUser("ERROR_M02: Unable to detect macrophage signal in "+title1+"");
					print("ERROR_M02: Unable to detect macrophage signal in "+title1+"");
				}
				if(ERROR==false){
					if((step==true)|(stepM==true)){
						setBatchMode("show");
					...
					updateResults;
					roiManager("reset");
					print("closing image "+title1+" without analysis");
					while (nImages>0) {					//del single ROIs
						selectImage(nImages);
						close();
					}
		...
		if(ERRc>0){
			print(""+ERRc+" images failed - see "+ERDir+"");
			ERROR=false;
		}else{
			print(""+ERRc+" images failed");
		}
...
//NEW
				...
				run("Enhance Contrast", "saturated=0.35");
				run("Flatten");
				print("ERROR_E01: saving failed image in"+ERDir+"");
				saveAs("Gif", ERDir+title2+"_par_failed.gif");
				print("________________");
				print("SKIPPING IMAGE "+title1+"");
				print("________________");
//manual option?		//waitForUser("ERROR_E01: Unable to detect particle signal in "+title1+"");
				print("ERROR_E01: Unable to detect particle signal in "+title1+"");
			}
			if(ERROR==false){	
				if((step==true)|(stepP==true)){
					setBatchMode("show");
...
//NEW
					...
					run("Enhance Contrast", "saturated=0.35");
					run("Flatten");
					print("ERROR_E02: saving failed image in"+ERDir+"");
					saveAs("Gif", ERDir+title2+"_mp_failed.gif");
					print("________________");
					print("SKIPPING IMAGE "+title1+"");
					print("________________");
//manual option?			//waitForUser("ERROR_E02: Unable to detect macrophage signal in "+title1+"");
					print("ERROR_E02: Unable to detect macrophage signal in "+title1+"");
				}
				if(ERROR==false){
					if((step==true)|(stepM==true)){
						setBatchMode("show");
...
//NEW
						...
						run("Enhance Contrast", "saturated=0.35");
						run("Flatten");
						print("ERROR_E03: saving failed image in"+ERDir+"");
						saveAs("Gif", ERDir+title2+"_endo_failed.gif");
						print("________________");
						print("SKIPPING IMAGE "+title1+"");
						print("________________");
	//manual option?			//waitForUser("ERROR_E03: Unable to detect endothelium signal in "+title1+"");
						print("ERROR_E03: Unable to detect endothelium signal in "+title1+"");
					}
					if(ERROR==false){
						roiManager("Select", newArray());
						run("Select All");
	...
	//analysis for circulation:
					...
					for (j=0; j<listH.length; j++) {
						...
						if(mcro==false){
							...
							print("FFT done");
							run("Bandpass Filter...", "filter_large=500 filter_small=2 suppress=None tolerance=20 autoscale saturate");	//fft supresses signals of branching vessels from ISVs
...
//NEW
								...
								run("Enhance Contrast", "saturated=0.35");
								run("Flatten");
								print("ERROR_C01: saving failed image in"+ERDir+"");
								saveAs("Gif", ERDir+title2+"_outl1_failed.gif");
								print("________________");
								print("SKIPPING IMAGE "+title1+"");
								print("________________");
			//manual option?			//waitForUser("ERROR_C01: Unable to detect fish outline in "+title1+"");
								print("ERROR_C01: Unable to detect fish outline in "+title1+"");
							}
							if(ERROR==false){
								roiManager("Select", 0);
								run("To Bounding Box");
			...
			//cut out fish region and turn for segment selection
								...
								if((step==true)|(stepO==true)){
									setBatchMode("show");
									waitForUser("selected region for image orientation, image "+title1+"");
								}
								roiManager("reset");
			//select segment to analyse
								...
								if((step==true)|(stepO==true)){
									setBatchMode("show");
									waitForUser("tesholded region for image orientation, image "+title1+"");
								}
								run("Dilate");
								run("Open");
								setOption("BlackBackground", true);
...
//NEW
									...
									run("Enhance Contrast", "saturated=0.35");
									run("Flatten");
									print("ERROR_C02: saving failed image in"+ERDir+"");
									saveAs("Gif", ERDir+title2+"_mseg_failed.gif");
									print("________________");
									print("SKIPPING IMAGE "+title1+"");
									print("________________");
	//manual option?						//waitForUser("ERROR_C02: Unable to detect muscle segments in "+title1+"");
									print("ERROR_C02: Unable to detect muscle segments in "+title1+"");
								}
								if(ERROR==false){
					//del last and first segments to use approx. "middle"
									...
									if((step==true)|(stepO==true)){
										setBatchMode("show");
										waitForUser("segment used for image orientation, image "+title1+"");
									}
									...
									if((step==true)|(stepO==true)){
										setBatchMode("show");
										waitForUser("center section of segment used for image orientation, image "+title1+"");
									}
			//measure x distance values on section of big (venous) vs small (anastomotic) signal to get orientation
									...
									if(roiManager("count") ==0){
										...
										run("Enhance Contrast", "saturated=0.35");
										run("Flatten");
										print("ERROR_C03: saving failed image in"+ERDir+"");
										saveAs("Gif", ERDir+title2+"_av_failed.gif");
										print("________________");
										print("SKIPPING IMAGE "+title1+"");
										print("________________");
	//manual option?							//waitForUser("ERROR_C03: Unable to detect anastomotic vessles in "+title1+"");
										print("ERROR_C03: Unable to detect anastomotic vessles in "+title1+"");
									}
									if(ERROR==false){
										roiManager("Select", 0);
										getBoundingRect(x, y, width, height);
										...
										if((step==true)|(stepO==true)){
											setBatchMode("show");
											waitForUser("detected anastomotic vessle for image "+title1+"");
										}
										roiManager("reset");
										...
										if(roiManager("count") == 0){
											...
											run("Enhance Contrast", "saturated=0.35");
											run("Flatten");
											print("ERROR_C04: saving failed image in"+ERDir+"");
											saveAs("Gif", ERDir+title2+"_plexus_failed.gif");
											print("________________");
											print("SKIPPING IMAGE "+title1+"");
											print("________________");
		//manual option?							//waitForUser("ERROR_C04: Unable to detect caudal vein plexus region in "+title1+"");
											print("ERROR_C04: Unable to detect caudal vein plexus region in "+title1+"");
										}
										if(ERROR==false){
											roiManager("Select", 0);
											getBoundingRect(x, y, width, height);
						...
						//orienting image on horizontal axis
											...
											if((step==true)|(stepO==true)){
												setBatchMode("show");
												waitForUser("Threshold for horizontal orientation, image "+title1+"");
											}
											...
											if(roiManager("count") == 0){
												...
												run("Enhance Contrast", "saturated=0.35");
												run("Flatten");
												print("ERROR_C05: saving failed image in"+ERDir+"");
												saveAs("Gif", ERDir+title2+"_outl2_failed.gif");
												print("________________");
												print("SKIPPING IMAGE "+title1+"");
												print("________________");
			//manual option?							//waitForUser("ERROR_C05: Unable to detect fish outline in "+title1+"");
												print("ERROR_C05: Unable to detect fish outline in "+title1+"");
											}
											if(ERROR==false){
												roiManager("Select", 0);
												...
												if((step==true)|(stepO==true)){
													setBatchMode("show");
													waitForUser("ellipse for horizontal orientation, image "+title1+"");
												}
												roiManager("Add");
												roiManager("Select", 0);
												roiManager("delete");
												...
												if(flip==true){ // and error is false - else del file (File.delete) - think further to del files but save in error
													titleS= getTitle;
	...
	//analyse high Mag images:
		...
		//detect muscle-segments and modify roi for artery (shape/move/rotate)
							...
							if((step==true)|(stepAR==true)){
								setBatchMode("show");
								waitForUser("Threshold for segment detection, image "+title1+"");
							}
...
//NEW
								...
								run("Enhance Contrast", "saturated=0.35");
								run("Flatten");
								print("ERROR_C06: saving failed image in"+ERDir+"");
								saveAs("Gif", ERDir+title2+"_mseg2_failed.gif");
								print("________________");
								print("SKIPPING IMAGE "+title1+"");
								print("________________");
//manual option?						//waitForUser("ERROR_C06: Unable to detect muscle segments in "+title1+"");
								print("ERROR_C06: Unable to detect muscle segments in "+title1+"");
							}
							if(ERROR==false){
		//delete first and last as inconsistent
								...
								if((step==true)|(stepAR==true)){
									setBatchMode("show");
									waitForUser("segments for artery ROI generation, image "+title1+"");
								}
		...
		//delete segment rois
			...
			//detect muscle-segments and modify roi for artery (shape by deletion of undesired signald based on muscle segment ROIS and expansion/contraction) 
								...
								if((step==true)|(stepAR==true)){
									setBatchMode("show");
									waitForUser("threshold for artery ROI redefinition 1, image "+title1+"");
								}
								...
								if(roiManager("count") == 0){
									...
									run("Enhance Contrast", "saturated=0.35");
									run("Flatten");
									print("ERROR_C07: saving failed image in"+ERDir+"");
									saveAs("Gif", ERDir+title2+"_mseg3_failed.gif");
									print("________________");
									print("SKIPPING IMAGE "+title1+"");
									print("________________");
		//manual option?					//waitForUser("ERROR_C07: Unable to detect muscle segments in "+title1+"");
									print("ERROR_C07: Unable to detect muscle segments in "+title1+"");
								}
								if(ERROR==false){
									nROI = parseInt(roiManager("count"));
									for (i=0; i<nROI; i++) {
				...
				//delete anastomotic regions + accumulations
									...
									if((step==true)|(stepARR==true)){
										setBatchMode("show");
										waitForUser("threshold for artery ROI redefinition 2, image "+title1+"");
									}
									...
									if((step==true)|(stepARR==true)){
										setBatchMode("show");
										waitForUser("threshold for final artery ROI, image "+title1+"");
									}
...
//NEW
										...
										run("Enhance Contrast", "saturated=0.35");
										run("Flatten");
										print("ERROR_C08: saving failed image in"+ERDir+"");
										saveAs("Gif", ERDir+title2+"_artROI_failed.gif");
										print("________________");
										print("SKIPPING IMAGE "+title1+"");
										print("________________");
	//manual option?							//waitForUser("ERROR_C08: Unable to generate artery ROI from "+title1+"");
										print("ERROR_C08: Unable to generate artery ROI from "+title1+"");
									}
									if(ERROR==false){
...
//delete anastomotic regions + accumulations from manual ROI
								...
								if((step==true)|(stepAR==true)){
									setBatchMode("show");
									waitForUser("threshold for manual artery ROI redefinition, image "+title1+"");
								}
								run("Analyze Particles...", "size="+PDanA+"-"+PDanB+" circularity="+PCanA+"-"+PCanB+" "+INCan+" add");
								ROIc = roiManager("count");
								if(ROIc>0){
								...
								if((step==true)|(stepARR==true)){
									setBatchMode("show");
									waitForUser("threshold for final manual artery ROI, image "+title1+"");
								}
								run("Analyze Particles...", "size="+PDafA+"-"+PDafB+" circularity="+PCafA+"-"+PCafB+" "+INCaf+" add");
								if(roiManager("count") == 0){
									ERROR=true;
...
//NEW
									...
									run("Enhance Contrast", "saturated=0.35");
									run("Flatten");
									print("ERROR: saving failed image in"+ERDir+"");
									saveAs("Gif", ERDir+title2+"_plexus_failed.gif");
									print("________________");
									print("SKIPPING IMAGE "+title1+"");
									print("________________");
	//manual option?						//waitForUser("ERROR: Unable to detect caudal vein plexus region in "+title1+"");
									print("ERROR_C09: Unable to detect caudal vein plexus region in "+title1+"");
								}
								if(ERROR==false){
//generate final ROI and measure:							
									roiManager("Select", newArray());
	...
	//detect fish outline in transmission:
		...
		if((step==true)|(stepW==true)){
			setBatchMode("show");
			waitForUser("detected edges in whole fish image, image "+title1+"");
		}
		...
		if((step==true)|(stepW==true)){
			setBatchMode("show");
			waitForUser("threshold for whole fish detection, image "+title1+"");
		}
...
//NEW
			...
			run("Flatten");
			print("ERROR: saving failed image in"+ERDir+"");
			saveAs("Gif", ERDir+title2+"_whole_failed.gif");
			print("________________");
			print("SKIPPING IMAGE "+title1+"");
			print("________________");
//manual option?	//waitForUser("ERROR: Unable to detect endothelium signal in "+title1+"");
			print("ERROR_W01: Unable to detect fish outline in "+title1+"");
			}
		if(ERROR==false){
		...
		if((step==true)|(stepW==true)){
			setBatchMode("show");
			waitForUser("final selection for whole fish, image "+title1+"");
		}
		if(batch == false){
			wait(50);
		}
	...
	if(ERRc!=0){
		showMessage("FAILED IMAGES", ""+ERRc+" Images failed - see output data in ERROR Folder: "+ERDir+"");
	}
